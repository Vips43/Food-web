   ...
   <div className="max-w-full m-2 p-3">
    <div className="bg-gray-700 text-white p-2 gap-2">
     <h3 className="capitalize font-semibold text-center">
      meal name: <span className="font-bold">{data.strMeal} </span>
     </h3>
     <div className="flex gap-2 items-center justify-between flex-wrap">
      <h3 className="capitalize font-semibold">
       meal category: <span className="font-bold">{data.strCategory}</span>
      </h3>
      <h3 className="capitalize font-semibold">
       Dish from: <span className="font-bold">{data.strArea} </span>
      </h3>
      <h3 className="capitalize font-semibold">
       Dish type: <span className="font-bold">{data.strMeal}</span>
      </h3>
     </div>
     <div>
      <a
